...
We require that all of these methods are visible from the script-level namespace (i.e. not nested inside classes or anything else)
In the model_to_visualisation script, we use import __name_of_this_script__ as difficulty_model, then calling difficulty_model.evaluate_difficulty(...)
"""
